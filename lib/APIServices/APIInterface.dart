...
class ApiInterface {
  ...
  String base_url = "http://192.168.1.146/FlutterPosBuild/api/";  
  ...
  Future<String> savePaymentResponseNew(jsonResponse) async {
    String url = base_url + 'SavePaymentResponseNew?User';
